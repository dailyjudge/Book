		...
		<div class="usedbooks-container">
			...
			<div class="usedbooks-item-1">
				<span class="usedbooks-item-title"
					onclick="location.href='UsedBooks_detail_controller?no=${i.no}'">${i.title }</span>
			</div>
			<div class="usedbooks-item-2">
				<span>${i.author }</span>
			</div>
			<div class="usedbooks-item-3">
				<span class="usedbooks-item-content">${i.content }</span> <span
					class="usedbooks-item-date">${i.date }</span>
			</div>
		</div>
	</c:forEach>
