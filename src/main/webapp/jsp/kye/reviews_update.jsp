...
<div class="usedbooks-create-container">
            ...
            <div class="usedbooks-create-item">
                <strong >제목</strong><br>
                <input id="review-update-title" class="usedbooks-create-item-title" type="text" name="title" value="${review.rv_title }">
            </div>
            
            <div class="usedbooks-create-item">
                <strong>내용</strong><br>
                <textarea id="review-update-content" class="usedbooks-create-textarea"name="content">${review.rv_content }</textarea>
            </div>
