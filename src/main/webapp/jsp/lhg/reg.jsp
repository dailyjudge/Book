	...
	<div class="reg-container">
		<form class="reg-form" method="post"
			...
			<div>
				...
				<input type="text" name="id" class="input_id" /> <img
					class="reg-questionMark" src="assets/questionMark.png" />
					<font id="checkId" size="2"></font>
			</div>
			<div>
				<h6 class="reg-field">비밀번호</h6>
				<input type="password" name="pw" id="pw" /> <img
					class="reg-questionMark2" alt="" src="assets/questionMark.png" />
			</div>
			<div>
				<h6 class="reg-field">비밀번호 재입력</h6>
				<input type="password" name="pw2" id="pw2" /> <font id="pwConfirm"
					size="2"></font>
			</div>
			<div>
				<h6 class="reg-field">이름</h6>
				<input type="text" name="name" /> <img class="reg-questionMark3"
					alt="" src="assets/questionMark.png" />
			</div>
			<div>
				<h6 class="reg-field">이메일</h6>
				<input type="text" name="email" /> <img class="reg-questionMark4"
					alt="" src="assets/questionMark.png" />
			</div>
			<div>
